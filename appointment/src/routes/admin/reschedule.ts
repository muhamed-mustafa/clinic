...
router.get('/api/appointment/admin/reschedule' , requireAuth , async (req : Request , res : Response) =>
{
    ...
    let appointments = await Appointment.find({ doctor : doctor.id , reschedule : true });
...
export { router as adminGetRescheduleAppointments };